...
$(warning [AGO] enable go build SVB_ENABLE_AGO $(SVB_ENABLE_AGO))

ifeq (yes,$(strip $(SVB_ENABLE_AGO)))
    ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
        $(warning [AGO] enable gmo build MTK_GMO_RAM_OPTIMIZE $(MTK_GMO_RAM_OPTIMIZE))
    ...
    DEVICE_PACKAGE_OVERLAYS += device/mediatek/common/overlay/ago_1gb
