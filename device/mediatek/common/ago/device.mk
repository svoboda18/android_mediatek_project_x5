...
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    ...
    PRODUCT_COPY_FILES += device/mediatek/common/ago/data/etc/go_handheld_core_hardware.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/handheld_core_hardware.xml
