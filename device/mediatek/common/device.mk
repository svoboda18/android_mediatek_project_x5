...
ifdef OPTR_SPEC_SEG_DEF
  ...
  # Telephony library for op sw decouple
    ...
    ifneq ($(wildcard vendor/mediatek/proprietary/operator/packages/services/Ims/common/Android.mk),)
      PRODUCT_BOOT_JARS += mediatek-ims-wwop-common
    endif
...
ifeq ($(strip $(MTK_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += \
      vendor.mediatek.hardware.keymaster_attestation@1.0-impl \
      vendor.mediatek.hardware.keymaster_attestation@1.0-service
endif
...
$(warning MTK_MOBILE_MANAGEMENT is $(MTK_MOBILE_MANAGEMENT))
ifneq ($(strip $(MTK_BASIC_PACKAGE)), yes)
    ifeq ($(strip $(MTK_BSP_PACKAGE)), yes)
        ifeq ($(strip $(MTK_MOBILE_MANAGEMENT)), yes)
