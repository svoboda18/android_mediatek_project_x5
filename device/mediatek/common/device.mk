...
ifeq ($(strip $(MTK_USB_CBA_SUPPORT)), yes)
    PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_usb_cba_support=1
endif
...
ifeq ($(strip $(CMCC_LIGHT_CUST_SUPPORT)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.cmcc_light_cust_support=1
endif
...
ifeq ($(strip $(MTK_DEVREG_APP)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_devreg_app=1
endif

ifeq ($(strip $(MTK_CT4GREG_APP)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_ct4greg_app=1
endif
...
ifeq ($(strip $(MTK_DUAL_MIC_SUPPORT)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_dual_mic_support=1
else
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_dual_mic_support=0
endif

ifeq ($(strip $(MTK_VOICE_UNLOCK_USE_TAB_LIB)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_is_tablet=1
else
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_is_tablet=0
endif
...
ifeq ($(strip $(MTK_RTT_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES +=  persist.vendor.mtk_rtt_support=1
endif
...
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += libteeservice_client
  ...
  PRODUCT_PACKAGES += vendor.trustonic.tee@1.0-client
  PRODUCT_PACKAGES += vendor.trustonic.teeregistry@1.0-client
...
# Log control for PowerHal
  ...
  PRODUCT_PROPERTY_OVERRIDES += persist.log.tag.power@2.0-impl=I
...
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.mtk_uce_support=1
