...
ST_SOFTWARE_VERSION="H6751.Lunar_B1.V01."
ST_SOFTWARE_INNER_VERSION="H6751.Lunar_B1.8+128.EU.11.0.Neutral.V01."
MTK_INTERNAL_BUILD_VERNO="alps-mp-r0.mp1-V8.288.svoboda18"
date=$(date +%d%m%Y)

echo "ro.build.id=$BUILD_ID"
echo "ro.build.display.id=$MTK_INTERNAL_BUILD_VERNO"
echo "ro.build.st.inner.sw=$ST_SOFTWARE_INNER_VERSION$date"
...
#securegroup build props:
echo "ro.internal.version=$MTK_INTERNAL_BUILD_VERNO"
